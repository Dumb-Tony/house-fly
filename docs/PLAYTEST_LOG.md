...
- Public browser verification (same PC and in-app browser as initial M1): played the complete optional example through the real rendered simulation; observed the broken lamp, crash feedback, human reaction, open exit, and final breakdown (110 / 150 / 400 / 165). Local best remained 0 after demo. “Your turn” entered normal play; Escape paused it correctly. This is browser-triggered automated replay, not manual feel testing.
- Visual follow-up: overlapping lamp score and CRASH labels were consolidated into one CRASH +400 label. Final publication is checked against the committed HTML.
